...
var routes = [
    ...
    { path: 'auteur/:id', component: auteur_component_1.AuteurComponent },
    { path: 'auteurs', component: auteurslist_component_1.AuteursListComponent },
    { path: 'articles', component: articleslist_component_1.ArticlesListComponent },
